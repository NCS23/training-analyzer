...
class OverpassClient:
    ...
    async def get_surface_along_route(
        ...
        Nutzt eine einzige Overpass-Query mit Union statt einzelner
        Requests pro Punkt. Zuverlässiger und schneller.
        """
    ...
    async def _batch_query_surfaces(self, sampled_points: list[dict]) -> list[str]:
        """Eine einzige Overpass-Query (POST) fuer alle Sample-Punkte."""
        around_parts = "\n".join(

...
def _assemble_prompt(today: date) -> str:
    ...
    parts = [
        ...
        "2. Designe phase_templates mit 7-Tage-Vorlagen pro Phase.",
        "3. Gib fuer JEDE Phase 'weeks' an (Anzahl Wochen fuer diese Phase).",
        "4. Setze start_date wenn der Plan NICHT sofort starten soll.",
        "5. Rufe dann generate_training_plan mit deinen phase_templates auf.",
        "",

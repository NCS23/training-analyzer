...
>
> Dieses Konzept ist **substantiell, nicht abgelöst** — Inhalte fließen ins
> **PRD §5.3 (AI Coach + AI Presence)** und **§1.3 (Leitprinzipien)** ein
> → [`../PRD.md`](../PRD.md).
>
> Quelldokument für: Drei-Stimmen-Architektur (Begleiter / Coach / Zeuge),
> Symbol-Konvention (Rabe), Lagom-Regel, Card-Header-Pattern „Insight · KI-GENERIERT".

> **Original-Status:** Entwurf v1
> **Letzte Aktualisierung:** 2026-04-25
> **Verwandt:** [../design/BRAND_STYLE_GUIDE.md](../design/BRAND_STYLE_GUIDE.md)
